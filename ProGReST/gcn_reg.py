...
from validate import get_valid_results, get_valid_dataset, get_valid_targets
...
if __name__ == '__main__':
    ...
    for i in range(0,12):
        ...
        name=f'ProGReST_property{i}_warmup{args.warmup}_epochs{args.epoch}', 
        # Track hyperparameters and run metadata
        config={
        "architecture": "ProGReST",
        })

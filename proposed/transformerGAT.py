...
from torch_geometric.nn import GATConv, Set2Set, TransformerConv
...
wandb.init(
      ...
      name=f'transformer_gat_sep_{epoch}', 
...
class GAT(torch.nn.Module):
    def __init__(self,
        ...
        self.conv =  TransformerConv(node_hidden_dim, node_hidden_dim, heads=1)
...
model = GAT(node_input_dim=train_dataset.num_features).to(device)
print(model)
